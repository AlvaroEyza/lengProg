...
public:
   ...
   Horario(vector<Profesor> profesores, vector<Aula> aulas, vector<Curso> cursos)
    ...
    void ImprimirEstados() {
        ...
        // Aquí se debe manejar el caso en el que no se encuentra la asignación
        // No se puede devolver una referencia a un objeto temporal
        // Por ejemplo, puedes lanzar una excepción o devolver una referencia a un objeto estático vacío
...
void CalcularBrillo(Horario horario) {
    double TotalClases = 0;
            ...
            double utilizacionTotal = (TotalClases / (50 * 12))*100;
           ...
           factorDistribucion =  factorDistribucion*100;
            ...
            double brillo1 = (utilizacionTotal *10 - factorDistribucion * 9) ;
        ...
        else
        {
            if(getAsignacion2(asignacion).getClase(hora, dia).getID() == 0){
                 ...
                 if(!BuscarProfesor(clase2.getProfesor()))
                 {
                    ...
                    asignacion.setClase(hora, dia, clase2);
                    profesor.setDisponibilidad(false, hora, dia);
                    aula.setDisponibilidad(false, hora, dia);
...
int main() {
    ...
    vector<Horario> Horarios = {horario1, horario2, horario3, horario4, horario5, horario6};
